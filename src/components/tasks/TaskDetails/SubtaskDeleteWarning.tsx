...
function SubtaskDeleteWarning({
  ...
  return (
    <div className="fixed inset-0 dark:bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-red-100 dark:bg-gray-900 border border-gray-400 dark:border-gray-800 rounded-xl p-6 w-full max-w-sm text-center shadow-2xl">
        <div className="mx-auto w-12 h-12 bg-red-500/10 text-red-500 rounded-full flex items-center justify-center mb-4">
          <AlertTriangle className="w-6 h-6" />
        </div>

        <h3 className="text-lg font-semibold text-black/80 dark:text-white mb-2">
          Delete Subtask?
        </h3>
